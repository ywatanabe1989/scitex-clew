...
# (project=scitex-clew, owner=ywatanabe1989, repo=scitex-clew,
...
TMPDIR="/tmp/publish-scitex_clew-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-clew dist/* uploaded to PyPI via manual OIDC trusted publishing"
