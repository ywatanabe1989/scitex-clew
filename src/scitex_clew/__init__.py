...
_LAZY_ATTRS: "dict[str, tuple[str, str | None]]" = {
    ...
    # _overlay (dataset / verify-status / peer-review overlays — op-2026-06-12-10)
    "Dataset": ("._overlay", "Dataset"),
    "VerifyStatus": ("._overlay", "VerifyStatus"),
    "Overlay": ("._overlay", "Overlay"),
    "ValidationReport": ("._overlay", "ValidationReport"),
    "set_dataset": ("._overlay", "set_dataset"),
    "get_dataset": ("._overlay", "get_dataset"),
    "list_datasets": ("._overlay", "list_datasets"),
    "set_verify_status": ("._overlay", "set_verify_status"),
    "get_verify_status": ("._overlay", "get_verify_status"),
    "add_overlay": ("._overlay", "add_overlay"),
    "update_overlay_status": ("._overlay", "update_overlay_status"),
    "get_overlay": ("._overlay", "get_overlay"),
    "list_overlays": ("._overlay", "list_overlays"),
    "overlays_to_json": ("._overlay", "overlays_to_json"),
    "overlays_from_json": ("._overlay", "overlays_from_json"),
    "validate_overlays": ("._overlay", "validate_overlays"),
    "migrate_add_overlay_tables": ("._overlay", "migrate_add_overlay_tables"),
}
...
__all__ = [
    ...
    # Overlay layer (dataset / verify-status / peer-review overlays)
    "Dataset",
    "VerifyStatus",
    "Overlay",
    "ValidationReport",
